					...
					<div class="row">
						<div class="col-md-12">
							<div class="card card-form">
								<form action="bahp" method="post" class="user" enctype="multipart/form-data">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="jmlh_penawaran" name="harga_penawaran" type="text" class="form-control input-border-bottom" required="">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="jmlh_negosiasi" name="harga_negosiasi" type="text" class="form-control input-border-bottom" required="">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nomor_dipa" name="nomor_dipa" type="text" class="form-control input-border-bottom" required="">
